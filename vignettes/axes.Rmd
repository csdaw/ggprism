...
from the `lemon` package functions `brackets_horisontal()` and 
`brackets_vertical`. I felt the idea fit well in `ggprism` therefore I 
have re-implemented them as the `guide_prism_brackets()` axis guide.
