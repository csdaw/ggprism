...
fruit flies and then observe the effect of this mutation their wings. Figure 2B, 
shown below, shows the percentage change in three fly wing attributes in homozygous 
_Tps1_ mutants compared to heterozygous _Tps1_ mutants. The data are separated
according to the sex of the fly.
...
the original plot, and also set the axes guides to `prism_bracket`.
...
We'll also apply the `prism_offset` guide so the axis line doesn't extend 
